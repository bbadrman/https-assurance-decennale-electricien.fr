...
final class Version20260427155042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE role role VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE admin RENAME INDEX email TO UNIQ_880E0D76E7927C74');
        $this->addSql('ALTER TABLE page CHANGE is_published is_published TINYINT NOT NULL');
        $this->addSql('ALTER TABLE page RENAME INDEX slug TO UNIQ_140AB620989D9B62');
        $this->addSql('ALTER TABLE section RENAME INDEX fk_2d737aefc4663e4 TO IDX_2D737AEFC4663E4');
    }
